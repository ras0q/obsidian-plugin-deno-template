...
2. Run `deno task dev`, which will:
    - Clone the [sample vault](https://github.com/kepano/kepano-obsidian) to `./vault-for-my-feature`
...
3. Run `gh release create ./dist/main.js ./dist/manifest.json ./dist/styles.css`
